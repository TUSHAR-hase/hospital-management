...
//       <div className="flex items-center justify-center w-full max-w-6xl bg-white rounded-3xl p-8 space-x-12">
//      <div className="w-1/2">
//              <img
//                  src={ registerGif}
...
//                />
//              </div>
//         <div className="w-1/2 space-y-8 animate__animated animate__fadeIn animate__delay-1s">
...
//             <div>
//               <label htmlFor="name" className="block text-xl font-medium text-gray-600">Full Name</label>
//               <input
//                 type="text"
//                 id="name"
...
//             <div>
//               <label htmlFor="password" className="block text-xl font-medium text-gray-600">Contact</label>
//               <input
//                 type="text"
//                 id="contact"
...
//             </div>
//             <div>
//               <label htmlFor="password" className="block text-xl font-medium text-gray-600">Address</label>
//               <input
//                 type="text"
//                 id="address"
...
//             <div>
//               <label htmlFor="role" className="block text-xl font-medium text-gray-600">Role</label>
//               <select
//                 id="role"
//                 value={role}
...
//           {/* Toggle to login */}
//           <div className="mt-6 bg-blue text-center">
